...
from ..bukkit import Material,EntityType

class EntityMaterial(Enum):
    ...
    def from_bukkit(cls,bukkit_material):
        return EntityMaterial(str(bukkit_material.name()).lower())

    def to_bukkit(self):
        return EntityType.valueOf(self.value.upper())

    def to_bukkit_key(self):
